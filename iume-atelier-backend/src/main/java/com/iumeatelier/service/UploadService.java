...
import com.iumeatelier.storage.FileStorage;
...
public class UploadService {
    ...
    private UploadResponse uploadFile(
        ...
        try {
            FileStorage.StoredFile stored = fileStorage.store(file, storedName, contentType);
            mediaAssetService.recordUpload(
                    storedName,
            ...
            return new UploadResponse(stored.publicUrl(), file.getOriginalFilename());
